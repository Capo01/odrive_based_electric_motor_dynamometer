...
ignore_temp_warning						= True 				# Will ignore high temperature readings and continue testing.
...
text_file_name              			= 'odrive_loss.csv' # Name of output text file which will contain the test data
